        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/about" className="text-muted hover:text-primary transition-colors duration-200 flex items-center gap-2">
                  <i className="fa-solid fa-angle-right text-xs"></i> About Us
                </Link>
              </li>
              <li>
                <Link to="/academics" className="text-muted hover:text-primary transition-colors duration-200 flex items-center gap-2">
                  <i className="fa-solid fa-angle-right text-xs"></i> Academics
                </Link>
              </li>
              <li>
                <Link to="/admissions" className="text-muted hover:text-primary transition-colors duration-200 flex items-center gap-2">
                  <i className="fa-solid fa-angle-right text-xs"></i> Admissions
                </Link>
              </li>
              <li>
                <Link to="/gallery" className="text-muted hover:text-primary transition-colors duration-200 flex items-center gap-2">
                  <i className="fa-solid fa-angle-right text-xs"></i> Campus Gallery
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link to="/notice-board" className="text-muted hover:text-primary transition-colors duration-200 flex items-center gap-2">
                  <i className="fa-solid fa-angle-right text-xs"></i> Notice Board
                </Link>
              </li>
              <li>
                <Link to="/fee-structure" className="text-muted hover:text-primary transition-colors duration-200 flex items-center gap-2">
                  <i className="fa-solid fa-angle-right text-xs"></i> Fee Structure
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-muted hover:text-primary transition-colors duration-200 flex items-center gap-2">
                  <i className="fa-solid fa-angle-right text-xs"></i> Support & Contact
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <ul className="space-y-4 text-sm text-muted">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="font-bold text-foreground">+1 (234) 567-890</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="bg-primary-soft p-2 rounded-md text-primary">
                  <i className="fa-solid fa-envelope"></i>
                </div>
                <a href="mailto:info@ramspublicschool.com" className="hover:text-primary transition-colors">
                  info@ramspublicschool.com
                </a>
              </li>
            </ul>
          </div>
