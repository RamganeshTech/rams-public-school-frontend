  ...
  return (
    <>
      ...
      */}
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <nav aria-label="Main Navigation" className="hidden md:block">
              <ul className="flex items-center space-x-8">
                ...
                <li>
                  <Link to="/academics" className="text-foreground hover:text-primary transition-colors duration-200 font-medium">
                    Academics
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="bg-primary hover:bg-primary-hover text-inverse px-5 py-2 rounded-md transition-colors duration-200 font-medium shadow-sm">
                    Contact Us
                  </Link>
                </li>
              </ul>
      ...
      <div 
        id="mobile-menu"
        className={`fixed top-0 left-0 h-full w-3/4 max-w-sm bg-white z-50 border-r border-black shadow-2xl transform transition-transform duration-300 ease-in-out md:hidden flex flex-col ${
