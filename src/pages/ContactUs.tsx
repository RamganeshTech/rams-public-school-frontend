...
//                   Tiruverkadu Rd, Ambigai Nagar, <br />
//                   MGR Nagar, Ayappakkam,<br />
//                   Chennai, Ayappakkam, Tamil Nadu 600077
//                 </p>
//                 {/* <a
...
//                 <a
//                   // href="https://www.google.com/maps/dir/?api=1&destination=13.095314,80.1260842" 
...
const ContactUs: React.FC = () => {
  return (
    <main className="bg-mainBg min-h-screen py-14 sm:py-20 md:py-24 relative overflow-hidden">

      {/* Background Decor (Zero Performance Cost) */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary-soft rounded-full blur-[120px] opacity-20 pointer-events-none" aria-hidden="true"></div>
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-primary-soft rounded-full blur-[100px] opacity-30 pointer-events-none" aria-hidden="true"></div>

      {/* Signature decorative motif — consistent with Hero/other sections */}
      <svg
        className="pointer-events-none absolute -top-16 -left-16 w-[380px] h-[380px] opacity-[0.05] text-primary hidden lg:block"
        viewBox="0 0 200 200"
        fill="none"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h1 className="font-display text-foreground text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight mb-4">
            Contact {SCHOOL_NAME || 'Us'}
          </h1>
          <p className="text-muted text-sm sm:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed">
            Whether you have questions about admissions, want to schedule a campus tour, or simply want to say hello, our team is here and ready to help.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-start">
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              ...
              {/* Phone Card */}
              <div className="bg-surface border border-border-soft rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="h-12 w-12 bg-info/10 rounded-xl flex items-center justify-center mb-6">
                  <i className="fa-solid fa-phone-volume text-2xl text-info" aria-hidden="true"></i>
                </div>
                <h3 className="text-foreground font-bold text-lg mb-2">Call Us</h3>
                <a
                  href={`tel:+91${SCHOOL_PHONENO}`}
              ...
              <div className="bg-surface border border-border-soft rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="h-12 w-12 bg-success/10 rounded-xl flex items-center justify-center mb-6">
                  <i className="fa-solid fa-envelope-open-text text-2xl text-success" aria-hidden="true"></i>
                </div>
                <h3 className="text-foreground font-bold text-lg mb-2">Email Us</h3>
                <a
                  href={`mailto:${SCHOOL_EMAIL}`}
            ...
            {/* Address & Location Card */}
            <address className="bg-surface border border-border-soft rounded-3xl p-6 sm:p-8 shadow-sm not-italic flex flex-col sm:flex-row gap-5 sm:gap-6 items-start">
              <div className="h-12 w-12 bg-primary-soft rounded-xl flex items-center justify-center flex-shrink-0">
                <i className="fa-solid fa-map-location-dot text-2xl text-primary" aria-hidden="true"></i>
              </div>
              <div>
            ...
            {/* Office Hours + Follow Us Cards */}
            {/* <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">

              <div className="bg-surface border border-border-soft rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="h-12 w-12 bg-warning/10 rounded-xl flex items-center justify-center mb-6">
                  <i className="fa-solid fa-clock text-2xl text-warning" aria-hidden="true"></i>
                </div>
                <h3 className="text-foreground font-bold text-lg mb-2">Office Hours</h3>
              ...
              <div className="bg-surface border border-border-soft rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="h-12 w-12 bg-primary/10 rounded-xl flex items-center justify-center mb-6">
                  <i className="fa-solid fa-share-nodes text-2xl text-primary" aria-hidden="true"></i>
                </div>
                <h3 className="text-foreground font-bold text-lg mb-3">Follow Us</h3>
                <div className="flex items-center gap-3">
                  <a
                    href="#"
                    aria-label="Facebook"
                    className="h-9 w-9 rounded-full bg-sub-header text-foreground/70 flex items-center justify-center hover:bg-primary hover:text-inverse transition-colors"
                  >
